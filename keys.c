...
{
	if (data->map.data[data->map.y - (int)data->pos.y][(int)(data->pos.x + data->dir.x * data->move_speed)] == 0)
		data->pos.x += data->dir.x * data->move_speed;
	if (data->map.data[data->map.y - (int)(data->pos.y + data->dir.y * data->move_speed)][(int)data->pos.x] == 0)
		data->pos.y += data->dir.y * data->move_speed;
}

void	key_a(t_data *data)
{
	if (data->map.data[data->map.y - (int)data->pos.y][(int)(data->pos.x + data->camera_plane.x * data->move_speed)] == 0)
		data->pos.x -= data->camera_plane.x * data->move_speed;
	if (data->map.data[data->map.y - (int)(data->pos.y + data->camera_plane.y * data->move_speed)][(int)data->pos.x] == 0)
